...
class WC_APIs {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      WC_APIs_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WC_APIS_VERSION' ) ) {
			$this->version = WC_APIS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - WC_APIs_Loader. Orchestrates the hooks of the plugin.
	 * - WC_APIs_i18n. Defines internationalization functionality.
	 * - WC_APIs_Admin. Defines all hooks for the admin area.
	 * - WC_APIs_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'apis/payment.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'apis/orders.php';
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wc-apis-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wc-apis-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wc-apis-public.php';

		$this->loader = new WC_APIs_Loader();
    ...
    private function define_wc_apis_hooks() {
		...
		$wc_rest_payment_controller = new WC_REST_Payment_Controller();

        $this->loader->add_action( 'rest_api_init', $wc_rest_payment_controller, 'register_routes' );
		...
		$wc_rest_order_controller = new WC_REST_Order_Controller();

        $this->loader->add_action( 'rest_api_init', $wc_rest_order_controller, 'register_routes' );
    }
	 ...
	 *
	 * @since     1.0.0
	 * @return    WC_APIs_Loader    Orchestrates the hooks of the plugin.
	 */
